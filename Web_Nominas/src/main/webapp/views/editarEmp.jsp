    ...
    <table>
        ...
        <c:forEach var="empleado" items="${empleados}">
            <tr>
                ...
                <td><c:out value="${empleado.dni}"></c:out></td> <!-- Muestra el DNI del empleado -->
                <td><c:out value="${empleado.nombre}"></c:out></td> <!-- Muestra el nombre del empleado -->
                <td><c:out value="${empleado.sexo}"></c:out></td> <!-- Muestra el sexo del empleado -->
                <td><c:out value="${empleado.categoria}"></c:out></td> <!-- Muestra la categoría laboral del empleado -->
                <td><c:out value="${empleado.anyos}"></c:out></td> <!-- Muestra los años trabajados del empleado -->
                <td><a href="views/editar.jsp">Editar</a></td> <!-- Proporciona un enlace para editar este empleado -->
            </tr>
        </c:forEach>
    </table>
